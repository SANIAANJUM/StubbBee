...
import SoldProductions from './SoldProductions'
...
function SellerHome(props) {
  ...
  const drawer = (
    <div>
      ...
      <Divider />
      <List>
        <ListItem button onClick={()=>{setScreen(0)}}><ListItemText primary="Add Production" /></ListItem>
        <ListItem button onClick={()=>{setScreen(1)}}><ListItemText primary="Productions" /></ListItem>
        <ListItem button onClick={()=>{setScreen(2)}}><ListItemText primary="Sold Productions" /></ListItem>
        <ListItem button onClick={()=>{setScreen(3)}}><ListItemText primary="Profile" /></ListItem>
  ...
  let Page;
  if(screen === 0){Page = <AddProduction></AddProduction>}
  else if(screen === 1){Page = <Productions></Productions>}
  else if(screen === 2){Page = <SoldProductions></SoldProductions>}
